            ...
            case 'scriptbot':
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `SCRIPT OF Malik bugbot is not available for everyone if you need then contact malik mehtab❤️`,
                            body: `Love You bro 😘`,
                            thumbnailUrl: 'https://i.ibb.co/5hYWrRH/thumb.png',
                            sourceUrl: global.link,
                            mediaType: 1,
...
break
            ...
            case 'bot':
            case 'mehtab':
                let xeonmenuoh = `Assalamualaikum!🤝 Dear 
╭───❮ *MALIK-MEHTAB* ❯
│ *ᴏᴡɴᴇʀ* :  _*® MALIK MEHTAB 🤍*_
│ *ᴘʀᴇғɪx* : .
│ *ᴘʟᴀᴛғᴏʀᴍ* : SELF HOST
│ *ᴘʟᴜɢɪɴꜱ* : 131 
│ *ʀᴜɴᴛɪᴍᴇ* : UNDEFINED
